...
function Confirm-ElasticsearchIsReachable
{
    ...
    $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -Method Head -Verbose:$VerbosePreference
...
function Remove-IndexedDocumentsInBatches
{
    ...
    $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -Method Post -Command $url -Body $body
    if ($response.StatusCode -eq 200)
    {
        ...
        while ($true)
        {
            ...
            $taskResponse = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -Method Get -Command "_tasks/$taskId"

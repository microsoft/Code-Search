****************************************************************************************************
To analyze Search issues in Azure DevOps Server 2025 (Elasticsearch 8.14), please share the following data as listed below
****************************************************************************************************
...
2. Share ElasticSearch logs
   Zip the folder <ElasticSearchFolderLocation>\elasticsearch\logs

...
function Remove-Index
{
    ...
    $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -Method Head -Command $indexToRemove -Verbose:$VerbosePreference
    if ($response.StatusCode -eq 200)
    {
        ...
        {
            $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -Method Delete -Command $indexToRemove -Verbose:$VerbosePreference
            if ($response.StatusCode -eq 200)
            {

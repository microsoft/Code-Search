...
function InvokeFunction
{
    ...
    try
    {
        & $command -Verbose:$VerbosePreference
        return $true
    }
    catch
    {
...
function RetryInvoke
{
    ...
    for ($attempts=0; $attempts -lt $RetryCount; $attempts++)
    {        
        try 
        {            
            & $RetryCommand -Verbose:$VerbosePreference
            break            
        }
        catch 
        {            
            if ($attempts -lt ($RetryCount - 1))
            {
                LogWarning "Attempt:$attempts Exception occurred. Sleeping and retrying..."
...
function RunScriptBlocks
{
    ...
    {
        $blockResult = & $block -Verbose:$VerbosePreference
        if (-not $blockResult)
        {
            return $false
        }
...
Export-ModuleMember -Function InvokeFunction, RetryInvoke, RunScriptBlocks
# SIG # Begin signature block
# MIIkSwYJKoZIhvcNAQcCoIIkPDCCJDgCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDSDGD1ONVSYXUU
# TbYr/WqFr6Asn9TmruCQ2aoa1KVU+6CCDYEwggX/MIID56ADAgECAhMzAAABA14l
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgTxMPVy+L
# 6i2ctcpJkJorprqJT9uIXS/UcfBgPANXt+owQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQA9ieYb23AtQJ/SmH66Hy0wyhvdgrCEn5EzSS1eivKo
# O/7SBssIfWxhA//kjuiL5TTeUR7X6zzXQ/ddSfWmxuKIYdbp5tfsc7w4IE6qv/Iv
# 0u1YqqYD1fQkNIJQmbcttOWm8wSnIHeiemQgAHV92idFHq+X+sQraVOHh8HPSvyW
# 1yd8+eQy7wAqOnBCxju1cKoTHYox5PmIMcbWFDJkieKkaZpPfFw98WHVbfvfTjTo
# 5T2PeXuKwjRRFWnNqWGCc+CoszJZmO253o8IVyP6rNZ8HqKepz3asbKmBDCithvp
# TT4LXX77DG2k1vJmn6wbJSqiqn57MtkMH114BAIHWheaoYITqjCCE6YGCisGAQQB
# gjcDAwExghOWMIITkgYJKoZIhvcNAQcCoIITgzCCE38CAQMxDzANBglghkgBZQME
# AgEFADCCAVQGCyqGSIb3DQEJEAEEoIIBQwSCAT8wggE7AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEILjo24j1kI4M1vTeVoH/1ev+IFr8oj2dbS7W0Fca
# pMl1AgZbzfPI3Z0YEzIwMTgxMDI0MjMzNDE4LjU1NFowBwIBAYACAfSggdCkgc0w
...
# DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCD7hl5UQqX8tLWEVJI1rhEKzEd0JGPFNcMJ
# wUTRGhw1IzCB4gYLKoZIhvcNAQkQAgwxgdIwgc8wgcwwgbEEFFsNM++YagpJXxuE
...
# KoZIhvcNAQELBQAEggEAjNJh0wkFhBYWy/XzRzHk4uIP61Q7+gHtYtVftXeHIQUP
# uNxonIEcOpSVpus+11zmdt3L5b2+xrTuteV3+ekXZyaSfOM2nc3TgwbBZMfFyXSt
# /g8W5Ol3RBgFznI+JXEzVfllePrjx6vYiPRyO6eIhNjH8br8XmZHA8RenGSpk1OJ
# FzNGe4OD+HTI93anf9syKQYs/HETjfqBfN8EoDyhhIHhnQ/oJi9OEerHsJvlhNfR
# AWsCwm2kmdeSIZSgcEl8a/xh4i11eY5ZQgSQ0KDDvAZV10sValgdvp8eBXi7NA5p
# bIojUfbHiMxxy1WOH6L1d55ACQ4VkQWWFvOJBO1HqQ==

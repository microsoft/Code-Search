$SupportedJavaNotFoundMessage = @"

Search requires Oracle Server JRE 8 (Update 60 or higher), and a suitable version was not detected or is not
correctly configured on this computer. If Server JRE is installed, see Java installation notes to resolve this and then rerun this installer.
"@

$ValidJavaInstallationMessage = @"

Valid Java installation detected.
...
Before you proceed, ensure you have Oracle Server JRE 8 Update 60 or higher installed and that JAVA_HOME variable is pointing to the Java installation directory. Read Java installation notes for more details:
https://go.microsoft.com/fwlink/?linkid=822603
"@

$TFSSearchInstallPathMessage = @"

Location of TFSSearch installation...

Provide installation directory for TFSSearch.
...
$TFSSearchIndexPathMessage = @"

Location of Search index...

Provide a local folder on this machine with sufficient space as the location of the Search index.
For Code Search hardware requirements read:
https://go.microsoft.com/fwlink/?linkid=825434
* For maximum performance, choose a folder backed by a solid state drive (SSD).

"@

$UpgradeMessage = @"
Upgrade the Search service to continue with Azure DevOps Server upgrade. Upgrading the Search service (from TFS 2018 Update 1 or earlier version) will require removal and re-indexing of code and work items in each applicable collection. During this time users may not see the full set of results in Search.
"@
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQuTK9hFsPHvs2
# uRZMWMk/SmlQIAkR7gLaaW6G8lEnlaCCDYEwggX/MIID56ADAgECAhMzAAABA14l
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgJUDMoz1k
# sU9Oe7l/O0dLCNKQiu/h7OTc0j4VVEYih3EwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQCSVuFuFWc+ym6yVf326y/yap2CrRDseotFxNWklQm/
# 3W/OvuQ5+UKVBa7v8H4eAIiXSh4J44DUHFq80/NL+6z7Idk6ho2lBWiY74q0PHxO
# DAfzalifLrrgmAoA9rchDixcEA3TQZyJ7LrCQIm9GG2pBRa2+jHbnzKZJUuLzdX/
# pLWSa6JmRXJiHXxNObTuVPZk/xE/gXcLgzSAj5K+WWZKH33VubT2md9oBJJInm5A
# F7pWahUIGnKgaivN+sIfHmwwAhTi842jeTNrMY+d6ZAAMKTjOwmsa5d//95MKcyo
# 6E5LFfBxxRZtIAqhmWwGj+HlmJQ77jiUzupxNS4rLrBeoYITqjCCE6YGCisGAQQB
# gjcDAwExghOWMIITkgYJKoZIhvcNAQcCoIITgzCCE38CAQMxDzANBglghkgBZQME
# AgEFADCCAVQGCyqGSIb3DQEJEAEEoIIBQwSCAT8wggE7AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIIKQ1zyXtGgKfbPY8HjtNitcPJvYOAzf+A9UUxbr
# 7zqEAgZbzef9IxkYEzIwMTgxMDI0MjMzNDEzLjMzN1owBwIBAYACAfSggdCkgc0w
...
# DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDy81tzbLFs/a7J4g/Rn1cBMHg0SlO2vDa0
# Gi9YkU+wMTCB4gYLKoZIhvcNAQkQAgwxgdIwgc8wgcwwgbEEFKbTADJlgr7EUMjs
...
# KoZIhvcNAQELBQAEggEAwwesP9Vb+kK35AiBiOLF3oAczA0XqB5PQJehklhfVeFM
# 72wt88EGZtmyq2kWM/MwybttUatr+MDxCy7jOYBGkphN/6+zccgkgwBbUdDyqHqv
# CcUyRZzopi6+7+vY+1jrUHytKQLCISxXrJEQM9iVmejqbkEKHSKpULh2XGwzHn1P
# ylP7qUA0+/IyUWbk8kdpEeEPD/uJdkJoGIDBcnUUUGJ7+iT+G9xLoaKViG6BnsG/
# HplSREY/XAeLGXHhvgYOCnaa3lJLu18TUMbu4EZSmip2DV8CEHzOg3wh9uRlwQha
# 785RrBpkt03RGKRUVXIedV45AAZ4mKRe6bxlwjW8yg==

...
# Elasticsearch diagnostics script for Azure DevOps Server 2025
#
# PURPOSE: Collects diagnostic information from Elasticsearch for troubleshooting search issues.
#          Generates a comprehensive diagnostic report including cluster health, indices, and settings.
#
# USAGE: .\ElasticsearchDiagnostics.ps1 -ElasticsearchServerUrl <url>
#
# EXAMPLES:
#   .\ElasticsearchDiagnostics.ps1 -ElasticsearchServerUrl "http://localhost:9200"
#   .\ElasticsearchDiagnostics.ps1 -ElasticsearchServerUrl "http://elastic-server:9200"
#
# OUTPUT: Creates an "Elasticsearch_Diagnostic.zip" file with all diagnostic data.
#
Param
(

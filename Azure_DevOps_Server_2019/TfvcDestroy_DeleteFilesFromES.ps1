...
$ESDeleteResponse = Invoke-WebRequest -Method POST -Uri $ElasticsearchServiceUrl$Command -Body $Body -Credential $ElasticsearchServiceCredential -ContentType "application/json"

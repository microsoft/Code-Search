...
function Request-FixElasticsearchClusterState
{
    ...
    $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -Method Get -Command "_cluster/allocation/explain" -Verbose:$VerbosePreference

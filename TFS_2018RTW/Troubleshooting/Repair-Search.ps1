<#
    ...
    .EXAMPLE
    PS>.\Repair-Search -SQLServerInstance . -ConfigurationDatabaseName AzureDevOps_Configuration -CollectionDatabaseName AzureDevOps_DefaultCollection -CollectionName DefaultCollection -ElasticsearchServiceUrl http://localhost:9200 -EntityType Code
    ...
    PS>.\Repair-Search <SQL and Elasticsearch connection parameters> -EntityType Code
    Repairs code search issues for a collection. Executes all recommended actions without asking for user confirmation.
#>
...
try
{
    ...
    {
        Write-Log "======================================================================================"
        Write-Log "No known issues found. System seems to be healthy. If not, please collect diagnostic data by following steps in https://github.com/Microsoft/Code-Search/blob/master/TFS_2018RTW/SearchDiagonistics/README.txt, and file an issue at https://developercommunity.visualstudio.com/content/problem/post.html?space=22." -Level Attention
        Write-Log "======================================================================================"
    }
    else
    {

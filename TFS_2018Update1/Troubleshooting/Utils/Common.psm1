...
function Confirm-ElasticsearchIsReachable
{
    ...
    $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -ElasticsearchServiceCredential $ElasticsearchServiceCredential -Method Get -Verbose:$VerbosePreference
...
function Remove-IndexedDocumentsInBatches
{
    ...
    do
    {
        ...
        $response = Invoke-ElasticsearchCommand -ElasticsearchServiceUrl $ElasticsearchServiceUrl -ElasticsearchServiceCredential $ElasticsearchServiceCredential -Method Delete -Command $url -Body $body

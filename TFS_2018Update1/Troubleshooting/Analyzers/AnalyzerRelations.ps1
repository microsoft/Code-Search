...
@{ 
    "Test-SqlHealth" = @("Test-ElasticsearchHealth", "Test-IndexingUnitPointsToDeletedIndex", "Test-InefficientTfvcCrawlingStoredProcedure", "Test-FaultInJobInInfiniteRetries", "Test-GeneralTfvcIssues")
